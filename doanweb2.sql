...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 13, 2023 lúc 02:44 PM
...
(9, 9, 8, 1, 0, 600000, 600000),
(10, 10, 48, 1, 0, 750000, 750000),
(11, 11, 47, 1, 0, 750000, 750000),
(12, 11, 31, 1, 0, 400000, 400000);
...
(3, 'Liver hơi non', 'Giảm giá sản phẩm', 'Liver hòa đội lên hạng', 0.3, '2023-11-06 00:00:00', '2023-11-07 00:00:00');
...
(1, 1, 1, 'Cần Thơ', '0899261564', 1, 480000, '0000-00-00 00:00:00'),
(2, NULL, 1, '275 phường 2, Q11 ,tp HCM', '0706524397', 0, 2730000, '2021-05-15 11:22:30'),
(3, NULL, 1, '275 phường 6, Q10 ,tp HCM', '0907624893', 0, 600000, '2021-05-15 11:23:44'),
(4, NULL, 1, '275 Nguyễn Biểu, phường 11, Q5 ,tp HCM', '0908624967', 0, 1400000, '2021-05-15 11:24:47'),
(6, NULL, 1, '117 phường 9, Q11 ,tp HCM', '0907455568', 0, 400000, '2021-05-16 01:37:08'),
(7, NULL, 1, '125/7 phường 9, Q9 ,tp HCM', '0708964526', 0, 600000, '2021-05-16 01:42:35'),
(8, 1, 4, 'HCM', '0899623648', 1, 700000, '0000-00-00 00:00:00'),
(9, NULL, 1, '117 phường 9, Q11 ,tp HCM', '0907656789', 0, 600000, '2023-10-21 03:32:53'),
(10, NULL, 1, '117 phường 9, Q11 ,tp HCM', '0907656788', 0, 750000, '2023-10-21 03:44:48'),
(11, NULL, 6, 'dasdas', '2132132323', 0, 1150000, '2023-11-13 01:19:56');
...
(1, 2, 'Nguyễn Đức Minh Trung', 'minhtrung@gmail.com', '0907656789', '1', '117 phường 9, Q11 ,tp HCM266'),
(3, 4, 'aaa', 'minhtrungaaa@gmail.com', '', '', NULL),
(4, 5, 'Trần Đại Nam', 'abc@gmail.com', '0899623648', 'Nam', 'HCM'),
(5, 6, 'daxuagankteam2k3', 'phanthanhnam200@gmail.com', '', '', NULL),
(6, 7, 'Vũ Thanh Bảo', 'phanthanhnam20023@gmail.com', '', '', NULL);
...
(1, 4, 'Nguyen Duc Anh', 'Anh@gmail.com', '0123456788', 'Nam');
...
(31, 'Funny-Club', 98, 400000, 'Hoodie', 'S', 'Không Mua Bây Giờ Thì Mua Bao Giờ!!!', 'Funny-Club.jpg'),
...
(47, 'Prive-Monogram-Cardigan', 39, 750000, 'Sweatshirt', 'M', 'Tái hiện cảm xúc của một kỳ nghỉ mát ngoài trời, \"Les Vacances\" mang đến những màu sắc mới tượng trưng cho màu của thiên nhiên: Màu xanh lá (Deep Green) của cây cỏ, màu nâu (Brown) của mùa thu, màu hồng cam (Living Coral) của những bông hoa dưới ánh mặt trời. Những gam màu này được kết hợp uyển chuyển với gam màu chủ đạo của Privé, tạo nên những phối màu sang trọng và trẻ trung, giúp cho kỳ nghỉ mát của bạn trở nên rực rỡ hơn bao giờ hết. \r\nĐược thiết kế dành cho những hoạt động ngoài trời, chất liệu chủ đạo của BST – len Rayon – luôn đảm bảo sự thoáng mát và thoải mái cho người mặc. Ngoài ra, sự đa dạng về kiểu dáng sản phẩm cũng giúp người mặc có nhiều lựa chọn hơn về phong cách để phù hợp nhất với mỗi chuyến đi của mình.', 'Prive-Monogram-Cardigan.jpg'),
...
(86, 'Sp test', 1, 2222110, 'Tee', 'S', 'HEHE', 'no_img.jpg ');
...
(1, 1, 'admin@gmail.com', 'admin123', 1, ''),
(2, 3, 'Pham Thanh Dat', 'e10adc3949ba59abbe56e057f20f883e', 0, 'dat@gmail.com'),
(3, 2, 'Dat Pham', 'nhanvien123', 1, 'dat123@gmail.com'),
(4, 3, 'aaa', 'e10adc3949ba59abbe56e057f20f883e', 1, 'livernon@gmail.com'),
(5, 3, 'Nguyen Duc Anh', 'e10adc3949ba59abbe56e057f20f883e', 1, 'abc@gmail.com'),
(6, 3, 'daxuagankteam2k3', '827ccb0eea8a706c4c34a16891f84e7b', 1, 'phanthanhnam200@gmail.com'),
(7, 3, 'Vũ Thanh Bảo', '693b4fc1e76c89738c6bc5af979b6d1d', 1, 'phanthanhnam20023@gmail.com');
...
--
-- AUTO_INCREMENT cho bảng `chitietgiamgia`
--
ALTER TABLE `chitietgiamgia`
  MODIFY `ID_CTGG` int(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT cho bảng `chitiethoadon`
--
ALTER TABLE `chitiethoadon`
  MODIFY `MA_CTHD` int(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT cho bảng `chitietphieunhap`
--
ALTER TABLE `chitietphieunhap`
  MODIFY `MA_CTPN` int(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;

--
-- AUTO_INCREMENT cho bảng `chuongtrinhgiamgia`
--
ALTER TABLE `chuongtrinhgiamgia`
  MODIFY `MA_CTGG` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `hoadon`
  MODIFY `MA_HD` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT cho bảng `khachhang`
--
ALTER TABLE `khachhang`
  MODIFY `MA_KH` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `sanpham`
  MODIFY `MA_SP` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
